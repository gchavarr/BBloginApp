...
@RestController
@RequestMapping("/api/b-blogin-app-kafka")
public class BBloginAppKafkaResource {
    private final Logger log = LoggerFactory.getLogger(BBloginAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BBloginAppKafkaResource(KafkaProperties kafkaProperties) {
